...
public class TypedPayloadRegistries {
    ...
    public static void init() {
        ...
        register(NbtTagPayload.class, NbtTagPayload::new, SyncedFieldAccessors.INBT_SERIALIZABLE_ACCESSOR, 100);
        register(ForgeRegistryPayload.class, ForgeRegistryPayload::new, SyncedFieldAccessors.FORGE_REGISTRY_ACCESSOR, 100);
