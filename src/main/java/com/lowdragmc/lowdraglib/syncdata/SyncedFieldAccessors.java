...
public class SyncedFieldAccessors {
    ...
    public static final IAccessor FORGE_REGISTRY_ACCESSOR = new ForgeRegistryAccessor();
    public static final IAccessor INBT_SERIALIZABLE_ACCESSOR = new INBTSerializableAccessor();
