...
public class ParticleManager {
    ...
    private final Map<ParticleRenderType, Queue<LParticle>> particles = Maps.newTreeMap(net.minecraftforge.client.ForgeHooksClient.makeParticleRenderTypeComparator(RENDER_ORDER));
